...
public class BasicexampleDao {
	...
	public Department getDepartmentByDepartmentId(int department_id) {
		return (Department) getSession().createCriteria(Department.class).add(Restrictions.eq("department_id", department_id)).uniqueResult();
	}
